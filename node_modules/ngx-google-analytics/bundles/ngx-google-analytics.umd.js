(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var NGX_WINDOW = new i0.InjectionToken("ngx-window", {
        providedIn: "root",
        factory: function () {
            var defaultView = i0.inject(i2.DOCUMENT).defaultView;
            if (!defaultView) {
    ...
    var GoogleAnalyticsService = /** @class */ (function () {
        ...
        GoogleAnalyticsService.prototype.gtag = function () {
            ...
            try {
                this._gtag.apply(this, __spreadArray([], __read(args.filter(function (x) { return x !== undefined; }))));
            }
            catch (err) {
                this.throw(err);
            }
        ...
        GoogleAnalyticsService.prototype.set = function () {
            ...
            try {
                this._gtag.apply(this, __spreadArray(['set'], __read(options)));
            }
            catch (err) {
                this.throw(err);
            }
    ...
    GoogleAnalyticsService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function GoogleAnalyticsService_Factory() { return new GoogleAnalyticsService(i0__namespace.ɵɵinject(NGX_GOOGLE_ANALYTICS_SETTINGS_TOKEN), i0__namespace.ɵɵinject(i2__namespace.DOCUMENT), i0__namespace.ɵɵinject(NGX_GTAG_FN)); }, token: GoogleAnalyticsService, providedIn: "root" });
            ...
            return __generator(this, function (_e) {
                ...
                try {
                    for (_b = __values(settings.initCommands), _c = _b.next(); !_c.done; _c = _b.next()) {
                        command = _c.value;
                        gtag.apply(void 0, __spreadArray([command.command], __read(command.values)));
                    }
                }
